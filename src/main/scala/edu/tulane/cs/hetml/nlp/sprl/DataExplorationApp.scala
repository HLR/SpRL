...
import edu.tulane.cs.hetml.nlp.sprl.Helpers.{CandidateGenerator, ImageReaderHelper, SpRLXmlReader}
import edu.tulane.cs.hetml.nlp.LanguageBaseTypeSensors.sentenceToPhraseGenerating
