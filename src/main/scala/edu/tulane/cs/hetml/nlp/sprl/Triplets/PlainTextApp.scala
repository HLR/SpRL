...
import edu.tulane.cs.hetml.nlp.sprl.MultiModalSpRLDataModel.{phrases, triplets}
...
import edu.tulane.cs.hetml.nlp.sprl.mSpRLConfigurator.{resultsDir, populateImages}
